...
from moire.updated_scoring import extract_downturns, extract_upturns
...
for field in SELECT_FIELDS:
    ...
    draw_heatmap_candidates(
        nu, T, R, linecuts, OUT=OUT / Path("heatmaps"), save=True, name=f"{field}_heatmap_opqaue"
    )
