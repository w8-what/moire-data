...
def plot_single_linecut_diagnostic(params: dict, T: list, rho: list, candidates: list[dict], OUT: Path) -> None:
...
def plot_all_linecuts_diagnostic(E: float, numLines: int, IN: Path, OUT: Path) -> None:
